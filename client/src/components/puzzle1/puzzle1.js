      ...
      <div className="game-header">
        ...
        <nav className="navbar navbar-light fixed-top">
          <div className="container-fluid">
            ...
            <h1 className="items-center mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-red-600 from-purple-400">Guess the Word</span></h1>
            <div className="inline-flex mt-2.5 md:mt-0">
              <button
                className="side-buttons-icons"
                type="button"
              ...
              <button
                className="side-buttons-icons px-3"
                type="button"
                data-bs-toggle="modal"
            ...
            >
              ...
              <div className="offcanvas-footer">
                <small className="copyright text-center">
                  Puzzle Arena Made with ❤️ by Mohak Bansal
                </small>
                <br></br>
                <small>
                  This website is developed for E-Litmus Assignment..
                </small>
              </div>
            </div>
          </div>
            ...
            <div className="modal-body">
              ...
              <div className="settings-options">
                <div className="settings-options-texts">
                  ...
                  <div>
                    <small>For improved color vision</small>
                  </div>
                </div>
                <div className="form-check form-switch">
                  <input
              ...
              <div className="settings-options">
                ...
                <div className="settings-options-side">Email</div>
              </div>
              ...
              <div className="settings-options">
                ...
                <div className="settings-options-side">Twitter</div>
              </div>
              ...
              <div className="settings-options">
                ...
                <div className="settings-options-side">FAQ</div>
              </div>
              <div>
                <small>Puzzle Arena Made with ❤️ by Mohak Bansal</small>
              </div>
            </div>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div>
                ...
                <div className="how-footer">
                  Have feedback? Email us at <a href="#" className="text-blue-800">Mohak64bansal@gmail.com</a>.
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="statistics-options">
                ...
                <div className="stats-boxes">
                  <div className="stats-box">
                    <div className="stats-num">{statistics.TotalPlayed}</div>
                    <div className="stats-text">Played</div>
                  </div>
                  ...
                  <div className="stats-box">
                    <div className="stats-num">{statistics.Streak}</div>
                    <div className="stats-text">Current Streak</div>
                  </div>

                  <div className="stats-box">
                    <div className="stats-num">{statistics.MaxStreak}</div>
                    <div className="stats-text">Max Streak</div>
                  </div>
                </div>

                <div className="guessdiv mt-2 mb-1">
                  <h6 className="stats-title" id="exampleModalLabel">
                    GUESS DISTRIBUTION
                  </h6>

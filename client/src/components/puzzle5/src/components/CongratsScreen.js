        ...
        <div id="congrats" className={className} style={style}>
            <div id="inner" 
                ...
                <div className="flex-grow-1 d-flex flex-column overflow-hidden p-2 m-0 m-sm-2 me-sm-1"
                    ...
                    <div className="mt-3 d-flex justify-content-center">You can check out other treasure hunts <a href="https://mohak-portfolio.vercel.app/" target="_blank" rel="noreferrer" className="ms-1">here</a>!</div>
                </div>
            </div>
